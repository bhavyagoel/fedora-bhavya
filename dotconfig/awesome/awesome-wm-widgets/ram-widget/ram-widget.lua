...
local function worker(user_args)
    ...
    local color_used = "#ff0000" or args.color_used or beautiful.bg_urgent
    local color_free = "#00c427" or args.color_free or beautiful.fg_normal
    local color_buf  = "#eaff00" or args.color_buf  or beautiful.border_color_active
