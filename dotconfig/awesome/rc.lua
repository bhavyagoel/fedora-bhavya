...
local browser1 = "brave-browser-stable"
...
awful.util.mymainmenu = freedesktop.menu.build({
    before = {{"Awesome", myawesomemenu} -- other triads can be put here
    },
...
awful.key({modkey}, "d", function()
    awful.spawn(string.format("rofi -show drun", beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus,
        beautiful.fg_focus))
end, {
...
awful.key({altkey, "Shift"}, "t", function()
    ...
    description = "Pywal Wallpaper trash",
    group = "altkey"
...
awful.key({}, "Print", function()
    ...
    description = "Flameshot Snippet",
    group = "screenshots"
}), awful.key({modkey1, "Shift"}, "Print", function()
    awful.util.spawn("scrot -u 'ArcoLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'")
end, {
...
end), --     awful.key({modkey}, "r", function () awful.util.spawn("redshift-gtk -l 27.2046:77.4977") end),
-- MPD control
...
--          properties = { callback = function (c) c.maximized = false end } },
{
    ...
    rule = {
        class = "com.github.alainm23.planner"
    },
    properties = {
        floating = false
    }
